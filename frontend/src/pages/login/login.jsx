...
import { login_auth } from '../../services/auth'
...
function Login() 
{
  ...
  const handleLogin = async (e) => {
    e.preventDefault();
    try {
      const responce = await login_auth(email, password);
  ...
  const handleRegisterThirdParty = (e , provider)=>{
    e.preventDefault();
   window.location.href = 'http://localhost:3000/api/auth/federated/google';
  }
  return (
    <>
      <section className="vh-100">
        {/* CHANGED: Combined Bootstrap's container-fluid with your module's h-custom */}
            ...
            <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              ...
              <form onSubmit={handleLogin}>
                <div className="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                  ...
                  onClick={(e) =>handleRegisterThirdParty(e , "facebook")}>
                ...
                {/* CHANGED: Combined Bootstrap's layout classes with your module's divider */}
